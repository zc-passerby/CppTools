...
#ifndef ZCUTILS_SINGLETON_H
#define ZCUTILS_SINGLETON_H
...
namespace zcUtils {
    ...
    template<typename T>
    Mutex Singleton<T>::ms_cGuard_;
}

#endif // ZCUTILS_SINGLETON_H